...
use App\Models\SystemVersionResponsibleDocument;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Storage;

class SystemVersionResponsibleDocumentController extends Controller
{
    private const DOC_TYPES = 'resolucion_directoral,resolucion_jefatural,memorando,oficio,contrato,acta,otro';

    public function store(Request $request, System $system, SystemVersion $version, SystemVersionResponsible $responsible)
    {
        ...
        $path = $file->store("sysver-responsible-docs/{$responsible->id}", 'local');
    ...
    public function download(System $system, SystemVersion $version, SystemVersionResponsible $responsible, SystemVersionResponsibleDocument $document)
    {
        $disk = $this->disk();
    ...
    public function preview(System $system, SystemVersion $version, SystemVersionResponsible $responsible, SystemVersionResponsibleDocument $document)
    {
        $disk = $this->disk();
    ...
    public function destroy(System $system, SystemVersion $version, SystemVersionResponsible $responsible, SystemVersionResponsibleDocument $document)
    {
