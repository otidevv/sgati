...
class SystemInfrastructureController extends Controller
{
    public function create(System $system)
    {
        ...
        return view('systems.tabs.infrastructure_create', compact('system', 'servers', 'sslCerts', 'serverIpsMap', 'serverEditUrls'));
    }
    ...
    public function store(Request $request, System $system)
    {
        ...
        return redirect(route('systems.show', $system) . '#infrastructure')
            ->with('success', 'Infraestructura registrada correctamente.');
    }
