...
<div {{ $attributes->merge(['class' => 'bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg hover:shadow-md dark:hover:shadow-gray-700/50 transition-shadow duration-300']) }}>
    @if($href)
