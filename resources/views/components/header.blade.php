    ...
    <div class="flex items-center justify-between h-16 px-4 sm:px-6 lg:px-8">
        ...
        <div class="ml-4 flex items-center md:ml-6 gap-3">
            ...
            <x-dropdown align="right" width="48">
                <x-slot name="trigger">
                    <button class="flex items-center max-w-xs text-sm rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 dark:focus:ring-offset-gray-800 focus:ring-blue-500">
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            <div class="hidden md:block text-left">
                                ...
                                @if(Auth::user()->role)
                                    <div class="text-xs text-gray-500 dark:text-gray-400">{{ Auth::user()->role->label }}</div>
                                @endif
                            </div>
