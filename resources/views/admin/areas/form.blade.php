...
<div class="max-w-2xl mx-auto space-y-6">
    ...
    <div class="flex items-center gap-4">
        <a href="{{ route('admin.areas.index') }}" class="inline-flex items-center justify-center w-10 h-10 rounded-lg bg-gray-100 text-gray-600 hover:bg-gray-200 dark:bg-gray-700 dark:text-gray-300 dark:hover:bg-gray-600 transition-colors">
        ...
        <form action="{{ isset($area->id) ? route('admin.areas.update', $area) : route('admin.areas.store') }}"
            ...
            <div>
                ...
                <div class="relative mt-1">
                    ...
                    <div class="absolute inset-y-0 right-2 flex items-center pointer-events-none">
                        ...
                        <svg x-show="nameStatus === 'checking'" class="w-4 h-4 text-gray-400 dark:text-gray-500 animate-spin" fill="none" viewBox="0 0 24 24">
                            <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                            <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8v8z"></path>
                        </svg>
                    </div>
                </div>
                <p x-show="nameStatus === 'taken'" class="mt-1 text-sm text-red-600 dark:text-red-400">Este nombre de área ya existe.</p>
                <p x-show="nameStatus === 'ok'" class="mt-1 text-sm text-emerald-600 dark:text-emerald-400">Nombre disponible.</p>
                @error('name')
            ...
            <div>
                ...
                <input type="text" id="acronym" name="acronym"
                       ...
                       class="mt-1 block w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm font-mono uppercase"
                       placeholder="OTI"
                       maxlength="20"
            ...
            <div>
                ...
                <textarea id="description" name="description" rows="4"
                          class="mt-1 block w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
            ...
            <div class="flex items-center justify-end gap-3 pt-4 border-t border-gray-200 dark:border-gray-700">
                <a href="{{ route('admin.areas.index') }}" class="px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-600 transition-colors">
                    Cancelar
                </a>
                <button type="submit"
