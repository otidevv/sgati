...
@section('content')
{{-- Script ANTES del x-data para que Alpine lo encuentre al inicializar --}}
<script>
function wizardForm(initialStep) {
    return {
        step: initialStep,
        submitting: false,
        nameError: false,
...
elseif ($errors->hasAny(['status','area_id'])) $initialStep = 2;
@endphp

<div class="max-w-3xl mx-auto" x-data="wizardForm({{ $initialStep }})">
    ...
    <form action="{{ route('systems.store') }}" method="POST"
        ...
        <div x-show="step === 1"
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm overflow-hidden">
                <div class="px-6 py-4 border-b border-gray-100 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-700/30">
                    ...
                    <p class="text-xs text-gray-400 dark:text-gray-500 mt-0.5">Identifica el sistema con un nombre claro y una breve descripción</p>
                </div>
        ...
        <div x-show="step === 2"
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm overflow-hidden">
                <div class="px-6 py-4 border-b border-gray-100 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-700/30">
                    ...
                    <p class="text-xs text-gray-400 dark:text-gray-500 mt-0.5">Estado operativo actual y área responsable del sistema</p>
                </div>
                <div class="p-6 space-y-6">
                    <div>
                        ...
                        <div class="grid grid-cols-2 sm:grid-cols-4 gap-3">
                            ...
                            @php
                            $checked = old('status', 'development') === $s->value;
                            $cm = [
                                'active'      => ['bg'=>'rgb(220,252,231)','bd'=>'rgb(22,163,74)',  'tx'=>'rgb(21,128,61)', 'dot'=>'rgb(22,163,74)'],
                                'development' => ['bg'=>'rgb(219,234,254)','bd'=>'rgb(37,99,235)',  'tx'=>'rgb(29,78,216)', 'dot'=>'rgb(37,99,235)'],
                                'maintenance' => ['bg'=>'rgb(254,243,199)','bd'=>'rgb(245,158,11)', 'tx'=>'rgb(146,64,14)','dot'=>'rgb(245,158,11)'],
                                'inactive'    => ['bg'=>'rgb(254,226,226)','bd'=>'rgb(220,38,38)',  'tx'=>'rgb(185,28,28)', 'dot'=>'rgb(220,38,38)'],
                            ];
                            $c = $cm[$s->value];
                            @endphp
                            <label class="cursor-pointer">
                                <input type="radio" name="status" value="{{ $s->value }}"
                                       ...
                                       onchange="document.querySelectorAll('input[name=status]').forEach(r=>{const d=r.nextElementSibling;d.style.background='';d.style.borderColor='rgb(229,231,235)';d.style.color='rgb(55,65,81)'});this.nextElementSibling.style.background='{{ $c['bg'] }}';this.nextElementSibling.style.borderColor='{{ $c['bd'] }}';this.nextElementSibling.style.color='{{ $c['tx'] }}';">
                                <div class="flex flex-col items-center gap-2 p-4 rounded-xl border-2 transition-all"
                                     style="background:{{ $checked ? $c['bg'] : '' }};border-color:{{ $checked ? $c['bd'] : 'rgb(229,231,235)' }};color:{{ $checked ? $c['tx'] : 'rgb(75,85,99)' }};">
                                    <span class="w-3 h-3 rounded-full" style="background:{{ $c['dot'] }};"></span>
                                    <span class="text-xs font-semibold text-center leading-tight">{{ $s->label() }}</span>
                                </div>
                            </label>
                            @endforeach
                        </div>
                    ...
                    <div>
                        <label for="area_id" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Área responsable</label>
        ...
        <div x-show="step === 3"
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm overflow-hidden">
                <div class="px-6 py-4 border-b border-gray-100 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-700/30">
                    ...
                    <p class="text-xs text-gray-400 dark:text-gray-500 mt-0.5">¿Cómo fue obtenido o desarrollado? (opcional)</p>
                </div>
                <div class="p-6 space-y-5">
                    ...
                    <div x-show="originType === 'donated'"
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="donor_name" value="{{ old('donor_name') }}" placeholder="Apellidos y nombres"
                            ...
                            <div>
                                ...
                                <input type="text" name="donation_document" value="{{ old('donation_document') }}" placeholder="R.D. 045-2024"
                                       class="block w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 shadow-sm focus:ring-purple-500 focus:border-purple-500 sm:text-sm">
                            </div>
                        </div>
                    </div>
                    ...
                    <div x-show="originType === 'third_party'"
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div class="sm:col-span-2">
                                ...
                                <input type="text" name="company_name" value="{{ old('company_name') }}" placeholder="Razón social o nombre"
                            ...
                            <div>
                                ...
                                <input type="text" name="contract_number" value="{{ old('contract_number') }}" placeholder="CONTRATO-001-2024"
                                       class="block w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 shadow-sm focus:ring-orange-500 focus:border-orange-500 sm:text-sm">
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <input type="number" name="contract_value" value="{{ old('contract_value') }}" min="0" step="0.01" placeholder="0.00"
                                       class="block w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 shadow-sm focus:ring-orange-500 focus:border-orange-500 sm:text-sm">
                            </div>
                            <div>
                    ...
                    <div x-show="originType === 'internal'"
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="team_name" value="{{ old('team_name') }}" placeholder="Nombre del equipo o área"
                                ...
                                <div class="grid grid-cols-3 sm:grid-cols-5 gap-2">
                                    ...
                                    <label class="cursor-pointer">
                                        <input type="radio" name="methodology" value="{{ $val }}"
                                               {{ old('methodology') === $val ? 'checked' : '' }} class="peer sr-only">
                    ...
                    <div x-show="originType === 'state'"
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="state_entity" value="{{ old('state_entity') }}" placeholder="SUNAT, RENIEC, MEF…"
                            ...
                            <div>
                                ...
                                <input type="text" name="state_entity_code" value="{{ old('state_entity_code') }}" placeholder="Código SIAF u otro"
                                       class="block w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 shadow-sm focus:ring-red-500 focus:border-red-500 sm:text-sm">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Código del sistema</label>
                                <input type="text" name="state_system_code" value="{{ old('state_system_code') }}"
                                       class="block w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 shadow-sm focus:ring-red-500 focus:border-red-500 sm:text-sm">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Fecha de implementación</label>
                                <input type="date" name="state_implementation_date" value="{{ old('state_implementation_date') }}"
                                       class="block w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 shadow-sm focus:ring-red-500 focus:border-red-500 sm:text-sm">
                            </div>
                            <div class="sm:col-span-2">
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">URL oficial del sistema</label>
                                <input type="url" name="state_official_url" value="{{ old('state_official_url') }}" placeholder="https://…"
                                       class="block w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 shadow-sm focus:ring-red-500 focus:border-red-500 sm:text-sm">
                            </div>
                            <div class="sm:col-span-2">
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Base legal</label>
                                <textarea name="legal_basis" rows="2" placeholder="Decreto, resolución o norma que sustenta su uso…"
                                          class="block w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 shadow-sm focus:ring-red-500 focus:border-red-500 sm:text-sm">{{ old('legal_basis') }}</textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div x-show="originType !== ''" x-transition>
                        ...
                        <textarea name="origin_notes" rows="2" placeholder="Observaciones adicionales…"
                                  class="block w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm">{{ old('origin_notes') }}</textarea>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div x-show="step === 4"
            ...
            <div class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-xl p-4">
                <div class="flex items-center justify-between mb-2">
                    <p class="text-xs font-semibold text-blue-700 dark:text-blue-300 uppercase tracking-wider">Resumen del registro</p>
                ...
                <div class="flex flex-wrap gap-2">
                    ...
                    <span class="inline-flex items-center gap-1.5 bg-white dark:bg-gray-800 rounded-lg px-3 py-1.5 border border-blue-100 dark:border-blue-800/50 text-xs text-gray-500 dark:text-gray-400">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm overflow-hidden">
                <div class="px-6 py-4 border-b border-gray-100 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-700/30">
                    ...
                    <p class="text-xs text-gray-400 dark:text-gray-500 mt-0.5">Tecnologías utilizadas y observaciones finales (opcional)</p>
                </div>
                <div class="p-6 space-y-4">
                    <div>
        ...
        <div class="flex items-center justify-between mt-5">
            ...
            <div>
                <a href="{{ route('systems.index') }}" x-show="step === 1"
            ...
            <div>
                ...
                <button type="submit" x-show="step === 4" :disabled="submitting"
                        class="inline-flex items-center gap-2 px-5 py-2 text-sm font-medium text-white bg-green-600 rounded-lg hover:bg-green-700 transition-colors shadow-sm disabled:opacity-60 disabled:cursor-not-allowed">
