@extends('layouts.app')
@section('title', 'Editar Repositorio — ' . $system->name)
...
<div class="max-w-2xl mx-auto space-y-6">
    <div class="flex items-center gap-4">
        ...
        <div>
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Editar Repositorio</h1>
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400 font-mono">{{ $repository->name }} — {{ $system->name }}</p>
        </div>
    </div>
