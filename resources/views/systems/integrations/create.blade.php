...
<div class="max-w-2xl mx-auto space-y-6">
    <div class="flex items-center gap-4">
        ...
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Nueva Integración</h1>
            <p class="mt-1 text-sm text-gray-500">
                <span class="font-semibold text-blue-600">{{ $system->acronym ?? $system->name }}</span>
    ...
    <div class="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
        <form action="{{ route('systems.integrations.store', $system) }}" method="POST" class="p-6 space-y-4">
            @csrf
            <div>
                <label for="target_system_id" class="block text-sm font-medium text-gray-700 mb-1">
