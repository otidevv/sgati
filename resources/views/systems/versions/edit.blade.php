...
<div class="max-w-2xl mx-auto space-y-6">
    <div class="flex items-center gap-4">
        ...
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Editar Versión <span class="font-mono text-blue-600">v{{ $version->version }}</span></h1>
    ...
    <div class="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
        <form action="{{ route('systems.versions.update', [$system, $version]) }}" method="POST" class="p-6 space-y-5">
            ...
            <div>
                <label for="changes" class="block text-sm font-medium text-gray-700 mb-1">Cambios</label>
                <textarea id="changes" name="changes" rows="4"
                          class="block w-full rounded-lg border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm">{{ old('changes', $version->changes) }}</textarea>
            </div>
