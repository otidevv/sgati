...
<div class="max-w-2xl mx-auto space-y-6">
    <div class="flex items-center gap-4">
        ...
        <div>
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Nueva Versión</h1>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm overflow-hidden">
        <form action="{{ route('systems.versions.store', $system) }}" method="POST" class="p-6 space-y-5">
            ...
            <div>
                <label for="changes" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Cambios / Notas de la versión</label>
