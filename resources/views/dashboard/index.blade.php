...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-500">Resumen general del sistema de inventario</p>
        </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 bg-white shadow-sm sm:rounded-lg">
            <div class="px-6 py-5 border-b border-gray-200">
                <div class="flex items-center justify-between">
                    <h3 class="text-lg font-semibold text-gray-900">Sistemas Recientes</h3>
                    <a href="{{ route('systems.index') }}" class="text-sm font-medium text-blue-600 hover:text-blue-500">
                        Ver todos →
                    </a>
                </div>
            </div>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-4">
                                        ...
                                        @if($system->acronym)
                                            <div class="text-xs text-gray-500">{{ $system->acronym }}</div>
                                        @endif
                                    </div>
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-900">{{ $system->area->name ?? 'N/A' }}</div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                        ...
                        <tr>
                            <td colspan="4" class="px-6 py-8 text-center text-gray-500">
                                ...
                                @can('systems.create')
                                    <a href="{{ route('systems.create') }}" class="mt-2 inline-block text-blue-600 hover:text-blue-500 text-sm font-medium">
        ...
        <div class="bg-white shadow-sm sm:rounded-lg">
            <div class="px-6 py-5 border-b border-gray-200">
                <h3 class="text-lg font-semibold text-gray-900">Alertas SSL</h3>
                <p class="text-xs text-gray-500 mt-1">Certificados próximos a vencer (30 días)</p>
            </div>
            <div class="p-6">
                    ...
                    <div class="mb-4 p-4 bg-yellow-50 border-l-4 border-yellow-400 rounded">
                        <div class="flex items-start">
                            ...
                            <div class="ml-3 flex-1">
                                <p class="text-sm font-medium text-gray-900">{{ $infra->system->name }}</p>
                ...
                @empty
                    <div class="text-center py-8">
                        ...
                        <p class="mt-2 text-sm text-gray-500">No hay alertas SSL pendientes</p>
                        <p class="mt-1 text-xs text-gray-400">Todos los certificados están vigentes</p>
                    </div>
                @endforelse
            </div>
        </div>
